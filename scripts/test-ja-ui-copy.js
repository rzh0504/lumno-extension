...
const expectedMessages = {
  ...
  blacklist_add: '隠すルールを追加',
  blacklist_empty: '非表示URLはまだありません',
  blacklist_removed_toast: '非表示リストから削除しました',
  favicon_blacklist_section_title: 'アイコン取得だけ止める',
  favicon_blacklist_add: '除外ルールを追加',
  favicon_blacklist_removed_toast: 'アイコン取得の除外から削除しました',
  ...
  favicon_blacklist_clear: '除外ルールを空にする',
  confirm_clear_favicon_blacklist: '除外ルールを空にしますか？',
